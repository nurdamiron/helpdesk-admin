...
export const formatTicketCategory = (category) => {
  ...
  const categoryMap = {
    'kk': {
      ...
      'billing': 'Есеп айырысу',
      'general': 'Жалпы сұрақтар',
      'it_support': 'IT қолдау',
      'equipment_issue': 'Жабдық мәселелері',
      'software_issue': 'БЖ мәселелері',
      'access_request': 'Қол жеткізу сұранысы',
      'complaint': 'Шағым',
      'suggestion': 'Ұсыныс',
      'hr_question': 'HR сұрағы',
      'safety_issue': 'Қауіпсіздік мәселесі',
      'training_request': 'Оқыту сұранысы',
      'policy_question': 'Саясат сұрағы',
      'other': 'Басқа',
      'default': 'Белгісіз'
    },
    'ru': {
